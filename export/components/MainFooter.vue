...
<template>
<footer class="footer" data-pgc="mainFooter">
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                ...
                <p class="footer__tagline">Digital marketplace for product collectibles. 
Buy, sell, and discover .</p>
                <div class="footer__lang">
                    <a class="footer__lang-btn" href="#" role="button" id="dropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="img/flags/uk.svg" alt=""> <span>English</span> </a>
                    <ul class="dropdown-menu footer__lang-dropdown" aria-labelledby="dropdownLang">
                        ...
                        <li>
                            <a href="#"><img src="img/flags/russia.svg" alt=""><span>Russian</span></a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer__content">
                    ...
                    <small class="footer__copyright">© Myrlly, 2021. Created by Luap.</small>
                </div>
            </div>
        </div>
    </div>
