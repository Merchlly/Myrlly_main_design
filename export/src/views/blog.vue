...
<main class="main">
    <div class="container">
        <div class="row row--grid">
            ...
            <div class="col-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb__item breadcrumb__item--active">Blog</li>
                </ul>
            </div>
            <!-- end breadcrumb -->
            <!-- title -->
        ...
        <div class="row row--grid">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="post">
                    <a href="article.html" class="post__img"> <img src="img/posts/4.jpg" alt=""> </a>
                    <div class="post__content">
                        <a href="#" class="post__category">Digital Art</a>
                        <h3 class="post__title"><a href="article.html">A Month of Rare Digital Art from MakersPlace</a></h3>
                        <div class="post__meta">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="post">
                    <a href="article.html" class="post__img"> <img src="img/posts/5.jpg" alt=""> </a>
                    <div class="post__content">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="post">
                    <a href="article.html" class="post__img"> <img src="img/posts/6.jpg" alt=""> </a>
                    <div class="post__content">
