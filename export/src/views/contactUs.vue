        ...
        <div class="row row--grid">
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                ...
                <ul class="contacts__list">
                    ...
                    <li>
                        <a href="mailto:support@myrlly.com">support@myrlly.com</a>
                    </li>
                    <li>
                        <a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="open-map">221B Baker St, Marylebone, London</a>
                    </li>
                </ul>
                <div class="contacts__social">
                    ...
                    <a href="mailto:support@myrlly.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
