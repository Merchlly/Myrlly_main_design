        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-8">
                <div class="asset__item">
                    <a class="asset__img" href="img/cover/cover-big.jpg"><img src="img/cover/cover-big.jpg" alt=""></a>
                    <!-- share -->
            ...
            <div class="col-12 col-xl-4">
                <div class="asset__info">
                    ...
                    <div class="asset__btns">
                        <a href="#modal-bid" class="asset__btn asset__btn--clr asset__btn--full bg-warning open-modal shadow">Buy</a>
                    </div>
                    <!-- end actions -->
                </div>
            </div>
