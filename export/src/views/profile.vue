            ...
            <div class="col-12 col-xl-3">
                <div class="author author--page">
                    <div class="author__meta">
                        ...
                        <h1 class="author__name"><a href="author.html">Store Name</a></h1>
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                        <div class="row row--grid">
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover1.jpg" alt=""> <span class="card__time card__time--clock"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover2.jpg" alt=""> <span class="card__time">15 minutes left</span> </a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover3.jpg" alt=""> <span class="card__time">an hour left</span> </a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover5.jpg" alt=""> <span class="card__time">an hour left</span> </a>
                        ...
                        <div class="row row--grid collapse" id="collapsemore">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- carousel card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover8.jpg" alt=""> </a>
                                    <h3 class="card__title"><a href="item.html">To Infinity And Beyond</a></h3>
                                    <div class="card__author card__author--verified">
                                        <img src="img/avatars/avatar5.jpg" alt="">
                                        <a href="author.html">@l1rose</a>
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel">
                        <div class="row row--grid">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover7.jpg" alt=""> </a>
                                    <h3 class="card__title"><a href="item.html">Les Immortels, the Treachery of Artificial Shadows</a></h3>
                                    <div class="card__author card__author--verified">
                                        <img src="img/avatars/avatar5.jpg" alt="">
                                        <a href="author.html">@l1rose</a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover6.jpg" alt=""> </a>
                                    <h3 class="card__title"><a href="item.html">Flowers in Concrete</a></h3>
                                    <div class="card__author card__author--verified">
                                        <img src="img/avatars/avatar5.jpg" alt="">
                                        <a href="author.html">@l1rose</a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <!-- card -->
                                <div class="card">
                                    <a href="item.html" class="card__cover"> <img src="img/cover/cover3.jpg" alt=""> </a>
                                    <h3 class="card__title"><a href="item.html">To Infinity And Beyond</a></h3>
                                    <div class="card__author card__author--verified">
                                        <img src="img/avatars/avatar5.jpg" alt="">
                                        <a href="author.html">@l1rose</a>
                            ...
                            <div class="col-12 col-xl-8 order-xl-1">
                                <div class="row row--grid">
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover1.jpg" alt=""> </a>
                                            <div class="activity__content">
                                                <h3 class="activity__title"><a href="item.html">Walking on Air</a></h3>
                                                <p class="activity__text">listed by <a href="author.html">@Nickname</a> <br>for <b>0.049 NGN</b></p>
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover2.jpg" alt=""> </a>
                                            <div class="activity__content">
                                                <h3 class="activity__title"><a href="item.html">To Infinity And Beyond</a></h3>
                                                <p class="activity__text">9 editions listed by <a href="author.html">@neo</a> <br>for <b>0.085 NGN</b> each</p>
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover3.jpg" alt=""> </a>
                                            <div class="activity__content">
                                                <h3 class="activity__title"><a href="item.html">Flowers in Concrete</a></h3>
                                                <p class="activity__text">purchased by <a href="author.html">@johndoe</a> <b>0x23d2dc92b...82c6</b> for <b>0.011 NGN</b> from <a href="author.html">@min1max</a></p>
                                                <span class="activity__time">21 minutes ago</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover4.jpg" alt=""> </a>
                                            <div class="activity__content">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover5.jpg" alt=""> </a>
                                            <div class="activity__content">
                                                <h3 class="activity__title"><a href="item.html">Tranquility</a></h3>
                                                <p class="activity__text"><a href="author.html">@aaarthur</a> offered <b>0.002 WNGN</b></p>
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover6.jpg" alt=""> </a>
                                            <div class="activity__content">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover7.jpg" alt=""> </a>
                                            <div class="activity__content">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-12">
                                        <div class="activity">
                                            <a href="item.html" class="activity__cover"> <img src="img/cover/cover8.jpg" alt=""> </a>
                                            <div class="activity__content">
                                                <h3 class="activity__title"><a href="item.html">Walking on Air</a></h3>
                                                <p class="activity__text">started following <a href="author.html">@johndoe</a></p>
